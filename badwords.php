...
Il primo file dovrà permettere all’utente di inserire i dati einv iare la richiesta al server.
...
<?php
    ...
    $wordCensored = str_replace($word, '***', $paragraph);
    $wordLength = strlen($word);
    $lenght = $paragraphLength - $wordLength;
?>
...
<body>
    <div class="container">
        ...
        <div class="card">
            ...
            <p>Lunghezz di: <?php echo $lenght; ?> caratteri</p>
        </div>
    </div>
</body>
</html>